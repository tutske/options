...
import static org.tutske.options.SimpleOptionSource.source;
...
public class CommandGroupTest {
	...
	public void it_should_recognize_deep_sub_commands () throws Exception {
		Option<String> first = new StringOption ("first");
		Option<String> second = new StringOption ("second");
		Option<String> third = new StringOption ("third");
	...
	public void it_should_allow_configuring_the_option_store_for_a_command () throws Exception {
		...
		store.register (Command.get ("run"), fn, config -> {
			...
			config.configureStore (store -> store.bind (source (consumer -> {
	...
	public void it_should_have_the_default_versions () throws Exception {
		Option<Boolean> verbose = new BooleanOption ("verbose");
		Option<String> name = new StringOption ("name", "John");
	...
	public void it_should_have_the_default_versions_for_parent_commands () throws Exception {
		Option<String> db = new StringOption ("db", "mysql://sub.domain.org/names");
		Option<Boolean> verbose = new BooleanOption ("verbose");
		Option<String> name = new StringOption ("name");
